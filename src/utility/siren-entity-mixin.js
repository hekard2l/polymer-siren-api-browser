import './entity-mixin.js';
import './siren-parser.js';
/*
		@polymerMixin
		@mixes window.EntityMixin
*/
window.SirenEntityMixin = function(superClass) {
	return class extends window.EntityMixin(superClass) {
